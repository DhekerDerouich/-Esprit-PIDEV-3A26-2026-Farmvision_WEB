 ...
 */
final class Version20260415230946 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rapport_personnalise (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(200) NOT NULL, type VARCHAR(50) NOT NULL, date_debut DATE DEFAULT NULL, date_fin DATE DEFAULT NULL, donnees JSON DEFAULT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, created_by INT DEFAULT NULL, INDEX IDX_AAAA0A49DE12AB56 (created_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE rapport_personnalise ADD CONSTRAINT FK_AAAA0A49DE12AB56 FOREIGN KEY (created_by) REFERENCES utilisateur (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE rapport_personnalise');
