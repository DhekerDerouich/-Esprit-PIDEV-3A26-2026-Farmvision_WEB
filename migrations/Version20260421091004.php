 ...
 */
final class Version20260421091004 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart (id INT AUTO_INCREMENT NOT NULL, session_id VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, status VARCHAR(50) DEFAULT NULL, UNIQUE INDEX UNIQ_BA388B7613FECDF (session_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE cart_item (id INT AUTO_INCREMENT NOT NULL, quantity DOUBLE PRECISION NOT NULL, price DOUBLE PRECISION NOT NULL, added_at DATETIME NOT NULL, marketplace_id INT NOT NULL, cart_id INT NOT NULL, INDEX IDX_F0FE25277078ABE4 (marketplace_id), INDEX IDX_F0FE25271AD5CDBF (cart_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE harvest_alert_seen (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, culture_id INT NOT NULL, seen_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE invoice (id INT AUTO_INCREMENT NOT NULL, invoice_number VARCHAR(50) NOT NULL, amount DOUBLE PRECISION NOT NULL, currency VARCHAR(50) NOT NULL, customer_email VARCHAR(100) NOT NULL, customer_name VARCHAR(100) DEFAULT NULL, items LONGTEXT DEFAULT NULL, pdf_path VARCHAR(255) DEFAULT NULL, stripe_session_id VARCHAR(100) DEFAULT NULL, created_at DATETIME NOT NULL, status VARCHAR(50) NOT NULL, UNIQUE INDEX UNIQ_906517442DA68207 (invoice_number), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE cart_item ADD CONSTRAINT FK_F0FE25277078ABE4 FOREIGN KEY (marketplace_id) REFERENCES marketplace (id_marketplace)');
        ...
        $this->addSql('ALTER TABLE stock ADD image_filename VARCHAR(255) DEFAULT NULL, ADD barcode VARCHAR(100) DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL, CHANGE statut statut VARCHAR(30) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE harvest_alert_seen');
        ...
        $this->addSql('ALTER TABLE stock DROP image_filename, DROP barcode, DROP updated_at, CHANGE statut statut VARCHAR(30) DEFAULT \'Disponible\'');
